    ...
    <main className="min-h-screen bg-black text-zinc-100 px-6 py-14">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="grid gap-4 sm:grid-cols-2">
          {/* Jonathan */}
          <a href="/midsummer/jonathan" className="rounded-2xl border border-zinc-700/60 p-5 hover:bg-zinc-100 hover:text-black transition">
            <h2 className="text-xl font-medium">Jonathan — Guided Workshop</h2>
            <p className="text-sm mt-1 text-current/70">Watch the talk → do the 15-min workshop.</p>
          </a>
